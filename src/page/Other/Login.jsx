        ...
        >
          ...
          <div className="flex flex-col gap-3 mt-6">
            ...
            <div className="relative">
              <input
                className="rounded-full px-3 py-2 w-full border border-gray-500/50 pr-10 text-sm"
          ...
          <button className="w-full text-center mt-4 hover:underline text-black/70 hover:text-black hover:cursor-pointer">
