...
const CartWidget = ({
  ...
  return (
    <>
      <div
        className={`${
          over ? "translate-y-0" : "-translate-y-100"
        } fixed bg-red-500 py-3 px-3 left-1/2 -translate-x-1/2 mt-5 rounded-md text-white font-oxygen transition-all duration-500`}
      >
