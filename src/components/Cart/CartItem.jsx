  ...
  return (
    <main className="grid grid-cols-[2fr_1fr_1fr_1fr] md:grid-cols-[3fr_1fr_1fr_1fr] gap-3 w-full py-5 px-4 border-t border-gray-300">
      <div className="flex gap-4 items-center">
        <FontAwesomeIcon
          className="text-gray-600 text-[12px] hover:cursor-pointer"
          icon={faX}
        />
        <img
          className="w-[50px] h-[50px] rounded-sm border border-gray-400"
          src={imgsrc}
          alt="name"
        />
        <span className="hidden md:block text-[16px] md:text-[18px]">
          {name}
        </span>
      </div>
      <h1 className="w-full flex items-center justify-center text-[14px] md:text-[16px]">
        ${finalPrice}
      </h1>
      ...
      <h1 className="w-full flex justify-center items-center text-[14px] md:text-[16px]">
        ${finalPrice * qty}
      </h1>
    </main>
  );
