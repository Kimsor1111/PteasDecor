...
const CartDetails = () => {
  ...
  return (
    <main className="w-full h-fit rounded-xl border border-gray-400 flex flex-col font-oxygen font-[400] text-[#3D3D3D] text-[16px]">
      <h1 className="py-5 bg-[#20263E] rounded-t-[11px] text-white ps-5 md:ps-[40px] lg:ps-5 text-[20px] font-poppins">
        Cart Details
      </h1>
      <div className="w-full px-5 flex flex-col">
        <div className="grid grid-cols-[2fr_1fr_1fr] border-b border-dashed border-[#949494] py-5">
          <h1>Product</h1>
          <h1 className="flex justify-center">Quantity</h1>
          <h1 className="flex justify-end">SUBTOTAL</h1>
        </div>
        <div className="flex flex-col gap-2 text-[#949494] text-sm font-oxygen py-5 border-b border-dashed border[#949494]">
        ...
        <div className="flex justify-between py-5 border-b border-dashed border-[#949494]">
